...
The second dashboard produced for social action gathers, from data collected for the Family Plan, indicators on the personnel of the defence base. A parallel study based on these data made it possible to determine the best location for the construction of a "crèche" (nursery) on the basin of a defence base.
...
Le deuxième tableau de bord réalisé pour l’action sociale réunit, à partir de données collectées pour le Plan Famille, des indicateurs sur le personnel de la BdD. Une étude réalisée en parallèle à partir de ces données a permis de déterminer le meilleur emplacement pour la construction d’une crèche sur le bassin d'une base militaire.
